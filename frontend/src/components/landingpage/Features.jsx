			...
			<Grid container spacing={6}>
				<Grid item xs={12} md={6}>
					<div>
						...
						>
							Manage your entire{' '}
							<b className="font-bold"> E-COMMERCE OPERATION</b>
							{'  '}
							from a single, User-friendly platform.{' '}
							<b className="font-bold">MyDukaan </b>
							provides you with the tools you need to streamline your business
							and boost your bottom line. Our three key features include:
						</Typography>
					</div>
					<Grid
						container
